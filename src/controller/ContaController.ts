...
export class ContaController implements ContaRepository {
    ...
    atualizar(conta: Conta): void {
        ...
        if(buscaConta != null) {
            ...
            console.log(colors.fg.green, "\nA Conta numero: " + conta.numero + " foi atualizado com sucesso!", colors.reset);
        } else
            console.log(colors.fg.red, "\nA Conta numero: " + conta.numero + " não foi encontrado!", colors.reset);
    }
    ...
    transferir(numeroOrigem: number, numeroDestino: number, valor: number): void {
        ...
        if(contaOrigem != null && contaDestino != null) {
            if(contaOrigem.sacar(valor) == true){
                ...
                console.log(colors.fg.green, "\nA transferência da Conta numero: " + numeroOrigem + " para a Conta numero: " + numeroDestino + " foi efetuado com sucesso!", colors.reset);
            } 
        } else 
